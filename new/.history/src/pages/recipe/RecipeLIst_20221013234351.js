...
function RecipeList() {
  ...
  //   fetch(`https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/random?query=${title}&number=20`, options)
  ...
  const filter = recipe.filter((x) => x.title.includes(str))
