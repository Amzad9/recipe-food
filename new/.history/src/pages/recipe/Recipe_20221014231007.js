...
function Home() {
  ...
  return (
    <>
    <div className="mt-20 min-h-72 bg-brand-100 grid grid-cols-12">
    <div className="col-span-6">
    <h1 className="text-gray-white text-5xl font-bold font-Montserrat">Fastest <span className="text-primary">Delivery</span> & Easy Pickup</h1>
