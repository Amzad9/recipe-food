...
function Home() {
  ...
  return (
    <>
    <div className="mt-20 min-h-72 bg-brand-100 grid grid-cols-12 items-center bg-[url('https://www.allrecipes.com/thmb/fSh16MWg7oA3Ze0nqPWclVH7xRw=/2000x666/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/8-5-Ingredient-Breakfast-Sandwiches-hero-02-99e824465e5d4c418083638974f5db97.jpg')] bg-cover bg-[url()]
