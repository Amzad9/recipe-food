...
import { slideOption } from "./../helper/Helper"
...
function RecipeList() {
  ...
  const fetchData = (title) => {
    ...
    fetch(`https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?query=salad`, options)
  ...
  // const filter = recipe.filter((x) => x.title)
