...
function Home() {
  ...
  useEffect(() => {
    ...
    // }
      ...
      fetch('https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/food/products/search?query=halal&number=10&offset=0&minCalories=0&maxCarbs=100&minCarbs=0&maxFat=100&minFat=0&maxProtein=100&minProtein=0&maxCalories=5000', options)
