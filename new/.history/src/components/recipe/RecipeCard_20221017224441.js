...
function RecipeCard({ image, imageAlt, sourceName, title, link , cardClass, onSave, btnClass, deleteBtnClass, onDelete, onAdded}) { 
  return (
    <>
          ...
          <img src={image} alt={imageAlt} className="w-44 h-44 rounded-full mx-auto" />
            ...
            <button className={`absolute top-4 right-4 ` +btnClass} onClick={onAdded}>
              add
            </button>
